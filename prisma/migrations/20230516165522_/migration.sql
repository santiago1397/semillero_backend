...
CREATE TABLE "Students" (
    ...
    "alergie" TEXT DEFAULT 'NO',
    "typeBlood" TEXT,
    "vaccinatedCovid" TEXT,
    "direction" TEXT,
    "estado" TEXT,
    "municipio" TEXT,
    "parroquia" TEXT,
    "localPhone" TEXT,
    "phone" TEXT,
    "firstNameResponsible" TEXT,
    "lastNameResponsible" TEXT,
    "identityResponsible" TEXT,
    "ageResponsible" TEXT,
    "relationshipResponsible" TEXT,
    "phoneResponsible" TEXT,
    "localPhoneResponsible" TEXT,
    "emailResponsible" TEXT,
    "professionResponsible" TEXT,
    "directionjobResponsible" TEXT,
    "agreeParticipes" TEXT,
    "createBy" INTEGER NOT NULL DEFAULT 0,
    "updatedBy" INTEGER,
    "version" INTEGER NOT NULL DEFAULT 0,
...
-- CreateIndex
CREATE UNIQUE INDEX "UsersRoles_userId_key" ON "UsersRoles"("userId");
...
-- AddForeignKey
ALTER TABLE "Entes" ADD CONSTRAINT "Entes_estadoId_fkey" FOREIGN KEY ("estadoId") REFERENCES "Estados"("id") ON DELETE NO ACTION ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Sites" ADD CONSTRAINT "Sites_estadoId_fkey" FOREIGN KEY ("estadoId") REFERENCES "Estados"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Sites" ADD CONSTRAINT "Sites_municipioId_fkey" FOREIGN KEY ("municipioId") REFERENCES "Municipios"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Sites" ADD CONSTRAINT "Sites_parroquiaId_fkey" FOREIGN KEY ("parroquiaId") REFERENCES "Parroquias"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "RoutesPlanned" ADD CONSTRAINT "RoutesPlanned_siteId_fkey" FOREIGN KEY ("siteId") REFERENCES "TypeSites"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "RoutesPlanned" ADD CONSTRAINT "RoutesPlanned_enteId_fkey" FOREIGN KEY ("enteId") REFERENCES "Entes"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
